...
Verificar este tutorial para instalação: [http://www.botanicaamazonica.wiki.br/labotam/doku.php?id=alunos:r.perdiz:disciplina:inicio](http://www.botanicaamazonica.wiki.br/labotam/doku.php?id=alunos:r.perdiz:disciplina:inicio).
...
* Comunicação - ação - meios a um fim

--

* Programar, em geral, consiste em definir *funções* e *variáveis*
...
Dúvidas são comuns quando programamos.
...
map(regions=paises,col='gray95',fill = TRUE,xlim=x1,ylim=y1) 
...
```{r, cache=TRUE, fig.width=12, fig.height=8, message=FALSE,warning=FALSE}
library("ggmap")
...
## Recursos para aprender linguagens de programação - *JavaScript*
...
## Assuntos abordados na postagem
...
Neste minicurso, utilizaremos apenas o pacote `dplyr`, a fim de simplificar o aprendizado.  
...
.pull-right[
<img style="border-radius: 60%;" src="figuras/final-slide_DSC_0507.jpg" width="250"/>
]
...
para o dia 2, explorar a parte de limpeza dos dados
